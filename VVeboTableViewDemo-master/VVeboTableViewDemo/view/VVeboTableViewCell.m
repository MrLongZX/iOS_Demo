...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        // 头像
        avatarView = [UIButton buttonWithType:UIButtonTypeCustom];
        //[[VVeboAvatarView alloc] initWithFrame:avatarRect];
...
//    NSLog(@"textRect:%@,\n subTextRect:%@",[_data[@"textRect"] CGRectValue],[_data[@"subTextRect"] CGRectValue]);
}
